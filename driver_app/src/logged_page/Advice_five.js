...
class AdviceFive extends Component {
    render() {
        return (
            <section className='grid-container mainContainer'>
                ...
                <div className="row">
                    <div className="col-10 advice-title__col">
                        <h3>Prowadzenie na zakrętach</h3>
                    </div>
                </div>
                <div className="row advice-image__row ">
                    <div className="col-9 advice-image__col advice advice5-image__col"></div>
                </div>
                ...
                <div className="row advice-info__row">
                    <div className="col-9 advice-info__col">
                        <span>5 przydatnych zasad prowadzenia na zakrętach</span>
                    </div>
                </div>
