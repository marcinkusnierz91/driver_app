...
class AdviceOne extends Component {
    render() {
        return (
            <section className='grid-container mainContainer'>
                ...
                <div className="row advice-image__row advice1-image__col">
                    <div className="col-9 advice-image__col advice"></div>
                </div>
                ...
                <div className="row advice-info__row">
                    <div className="col-9 advice-info__col">
                        <span>5 przydatnych zasad do jazdy po mieście</span>
                    </div>
                </div>
