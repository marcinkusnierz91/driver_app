...
class AdviceThree extends Component {
    render() {
        return (
            <section className='grid-container mainContainer'>
                ...
                <div className="row advice-image__row">
                    <div className="col-9 advice-image__col advice advice3-image__col"></div>
                </div>
                ...
                <div className="row advice-info__row">
                    <div className="col-9 advice-info__col">
                        <span>5 przydatnych wskazówek dotyczących technik hamowania</span>
                    </div>
                </div>
